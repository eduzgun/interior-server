...
with app.app_context():
    ...
    entry7 = Rooms(name="My personal room", dimensions="12 ft x 18 ft", description="My new room for my new house", theme="Art Deco" , category="BEANS", cover_image='https://interior-cloud-store.s3.amazonaws.com/environment-maps/0/px.png', user_id=1)
    entry8 = Rooms(name="My living room", dimensions="12 ft x 18 ft", description="My new living room for my new house", theme="Bohemian" ,category="BEANS", cover_image='https://interior-cloud-store.s3.amazonaws.com/environment-maps/2/px.png', user_id=2)
    entry9 = Rooms(name="My bathroom", dimensions="12 ft x 18 ft", description="My new bathroom for my new house", theme="12 ft x 18 ft" ,category="BEANS", cover_image='https://interior-cloud-store.s3.amazonaws.com/environment-maps/2/px.png', user_id=3)
